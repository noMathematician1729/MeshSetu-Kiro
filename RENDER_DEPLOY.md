...
- `meshsetu-admin-dashboard`: operator dashboard static site from `admin-dashboard/`
- `meshsetu-control-room-backend`: Node/Express API + WebSocket service from `backend/`
