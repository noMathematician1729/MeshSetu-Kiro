...
abstract class UniversalBlePeripheralPlatform {
  ...
  Stream<BlePeripheralNotificationSent> get notificationSentStream =>
      _blePeripheralStreamHandler.notificationSentStreamController.stream;
  ...
  void updateNotificationSent(BlePeripheralNotificationSent event) {
    _blePeripheralStreamHandler.notificationSentStreamController.add(event);
  }
...
class _BlePeripheralStreamHandler {
  ...
  final notificationSentStreamController =
      UniversalBleStreamController<BlePeripheralNotificationSent>();
  ...
  void dispose() {
    ...
    notificationSentStreamController.close();
  }
}
