...
class UniversalBlePeripheral {
  ...
  /// Android GATT notification completion (BluetoothGattCallback status).
  static Stream<BlePeripheralNotificationSent> get notificationSentStream =>
      _platform.notificationSentStream;
