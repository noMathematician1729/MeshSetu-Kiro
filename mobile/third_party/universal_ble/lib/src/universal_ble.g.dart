...
class PeripheralAndroidOptions {
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! PeripheralAndroidOptions ||
        other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
...
class PeripheralPlatformConfig {
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! PeripheralPlatformConfig ||
        other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
...
class UniversalBleAndroidChannel {
  ...
  Future<bool> hasBluetoothAdvertisePermission() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.universal_ble.UniversalBleAndroidChannel.hasBluetoothAdvertisePermission$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<bool> requestBluetoothAdvertisePermission() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.universal_ble.UniversalBleAndroidChannel.requestBluetoothAdvertisePermission$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> reconnectPeripheral(String deviceId) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.universal_ble.UniversalBleAndroidChannel.reconnectPeripheral$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> updateCharacteristicWithId(
    String characteristicId,
    Uint8List value,
    String? deviceId,
    int notificationId,
    ...
    final pigeonVar_channelName =
        'dev.flutter.pigeon.universal_ble.UniversalBleAndroidChannel.updateCharacteristicWithId$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[characteristicId, value, deviceId, notificationId],
    );
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    _extractReplyValueOrThrow(
      pigeonVar_replyList,
...
abstract class UniversalBlePeripheralCallback {
  ...
  static void setUp(
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.universal_ble.UniversalBlePeripheralCallback.onNotificationSent$messageChannelSuffix',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
